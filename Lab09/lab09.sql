...
CREATE TABLE lab09.wykladowca (
    ...
    FOREIGN KEY (manager_id) REFERENCES lab09.wykladowca(wykladowca_id) -- relacja samoodwołująca
);
...
CREATE TABLE lab09.wykladowca_kurs (
...
INSERT INTO lab09.wykladowca (wykladowca_id, nazwisko, manager_id, rok_zatrudnienia, wynagrodzenie, instytut_id) VALUES
...
INSERT INTO lab09.wykladowca_kurs (wykladowca_id, kurs_id) VALUES
(1, 1),
(2, 1),
(3, 2),
(4, 2),
